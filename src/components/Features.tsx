        ...
        <div className='space-y-16 md:space-y-24'>
          <div className='transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100'>
            <div className='space-y-5 md:text-center'>
              ...
              <p className='text-xl text-gray-200 md:text-2xl'>
                Each feature is specifcially made for devs and aimed at making{' '}
                <span className='font-semibold'>your</span> life easier.
              </p>
            </div>
          </div>
          <div className='grid grid-cols-1 grid-rows-2 gap-8 text-lg md:grid-cols-2 lg:grid-cols-3'>
            <div className='flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5'>
              ...
              <h3 className='text-xl font-semibold text-white'>Your favorite stack ♡</h3>
            ...
            <div className='flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5'>
              ...
              <h3 className='text-xl font-semibold text-white'>The latest technologies</h3>
              <p className='text-gray-200'>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <div className='flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5'>
              ...
              <h3 className='text-xl font-semibold text-white'>One coffee is all it'll take</h3>
              <p className='text-gray-200'>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <div className='flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5'>
              ...
              <h3 className='text-xl font-semibold text-white'>Stunning, beautiful look</h3>
              <p className='text-gray-200'>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <div className='flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5'>
              ...
              <h3 className='text-xl font-semibold text-white'>Suggestions are welcome</h3>
              <p className='text-gray-200'>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <div className='flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5'>
              ...
              <h3 className='text-xl font-semibold text-white'>Get users, fast.</h3>
              <p className='text-gray-200'>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
